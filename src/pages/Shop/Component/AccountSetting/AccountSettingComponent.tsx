...
function AccountSettingComponent({ pageName, itemName }: AccountSettingProps) {
  return (
      ...
      <div className="option">
        <ul className="options">
          <li className="option">
            ...
            {pageName.toUpperCase() === 'MY-ACCOUNT' && (
              <ul className="sub-option-list">
                <li
                  className={
                    itemName.toUpperCase() === 'PROFILE'
                      ? 'sub-option active'
                      : 'sub-option'
                  }
                >
                ...
                <li 
                  className={
                    itemName.toUpperCase() === 'CHANGE-PASSWORD'
                      ? 'sub-option active'
                      : 'sub-option'
                  }
                >
                ...
                <li 
                  className={
                    itemName.toUpperCase() === 'NOTIFICATION'
                      ? 'sub-option active'
                      : 'sub-option'
                  }
                >
          ...
          <li className="option">
            <Link to="/user/setting/notification">
              <FaBell id="faBell" className="account-icon" />
              Thông Báo
            </Link>
            {pageName.toUpperCase() === 'MY-NOTIFICATION' && (
              <ul className="sub-option-list">
